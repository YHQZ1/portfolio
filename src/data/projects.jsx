export const projects = [
  ...
  },
  {
    ...
    category: "focused",
    description:
      "A desktop application designed to manage customers, inventory, vendors, and orders from a single interface, focusing on structured data handling and operational workflows.",
  ...
  },
  {
    ...
    category: "focused",
    description:
      "A developer utility that automatically saves accepted competitive programming solutions to GitHub, reducing manual bookkeeping and keeping solution archives versioned and organized.",
  ...
  },
  {
    ...
    category: "focused",
    description:
      "A lightweight browser extension that allows users to control video playback speed using simple keyboard shortcuts, optimizing video consumption without UI clutter.",
